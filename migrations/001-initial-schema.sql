...
INSERT INTO Post (title, content, categoryId) VALUES ("My first blog post", "**My main content**", 1);
INSERT INTO Post (title, content, categoryId) VALUES ("How use GraphQL", "# ~~GraphSQL FTW~~", 2);
